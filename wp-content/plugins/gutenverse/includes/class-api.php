...
class Api {
	...
	public function modify_global_variable( $request ) {
		...
		$result = $this->save_option( $request, 'googlefont', 'gutenverse-global-variable-google-' . $theme );
		$result = $this->save_option( $request, 'fonts', 'gutenverse-global-variable-font-' . $theme );
		$result = $this->save_option( $request, 'colors', 'gutenverse-global-variable-color-' . $theme );
